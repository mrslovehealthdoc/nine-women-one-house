...
const shareText = `i got ${primary.name} with ${modifier.name} energy. take the quiz: nine women, one house.`;
  ...
  <div className="px-6 pb-8 text-center">
    <div className="max-w-md mx-auto">
      <p className="text-sm text-stone-600 mb-4 italic">
        send this to the friend who's most <em>{primary.name.toLowerCase().replace("the ", "")}</em>
      </p>
      <button
        onClick={handleShare}
