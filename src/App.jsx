...
const CORES = { 
 ...
 'own at least one tote bag with a snack, a swimsuit, and a library book in it',  'have said "wait — let\'s just go" within the last two weeks',  'have a camera roll that\'s 70% sky, water, and the back of your kids\' heads',  'know exactly how long it takes to pack the car for an unplanned day'  ]}, 
 { label: 'your superpower', content: 'aliveness. you remember that this is supposed to { label: 'with your kids', content: '"get in the car." you are the mom of spontaneous  { label: 'your home', content: 'lived-in and barely indoors. the back door is open. th { label: 'your marriage / partner', content: 'you\'re the one who suggests the trip. y { label: 'your friendships', content: 'you\'re the friend who texts "i\'m outside" wit { label: 'your friday night', content: 'depends entirely on the weather and a feeling  { label: 'your work', content: 'you do best when there\'s room to move and go. you\'re { label: 'how you move', content: 'outside, ideally. a hike, a beach walk, a run that  { label: 'your shadow side', content: 'the same engine that says yes to everything has { label: 'the wink', content: 'you have at least one half-dead plant you keep watering ] 
 }, 
 feral: { 
 name: 'The Feral Domestic', 
 opening: 'you read three sentences of the recipe and started anyway.',  vibe: 'she figured it out.', 
 secondaryShort: 'you also have Feral Domestic running underneath — the maker, the hands- sections: [ 
 { label: 'you definitely', content: [ 
 ...
 'have YouTube tutorials open on your phone that you don\'t need to actually finish w ]}, 
 { label: 'your superpower', content: 'full conviction without a tutorial. you start. t { label: 'with your kids', content: 'they\'re in it with you. flour on the counter, ch { label: 'your home', content: 'in a state of becoming. there is always a project. the
 ...
 { label: 'your shadow side', content: 'you absorb. you take on what isn\'t yours. you  { label: 'the wink', content: 'your camera roll has at least four screenshots of texts ] 
 }, 
 force: { 
 ...
 { label: 'your superpower', content: 'attunement and depth. you read rooms, weather, k { label: 'with your kids', content: 'you clock the shift in the room before anyone els { label: 'your home', content: 'considered. sensory. nothing in your house is there by { label: 'your marriage / partner', content: 'you read your partner. you know when the { label: 'your friendships', content: 'small circle. real ones. you don\'t have forty  { label: 'your friday night', content: 'slow. observed. low input. you might be alone  { label: 'your work', content: 'you do best in work that rewards perception and depth. { label: 'how you move', content: 'attuned. your body tells you what it needs and you  { label: 'your shadow side', content: 'you absorb the room. what you notice doesn\'t j { label: 'the wink', content: 'you have a photo of clouds on your phone. you have stop ] 
 }, 
 weaver: { 
 name: 'The Weaver', 
 ...
 { label: 'your superpower', content: 'openness as discipline. you have practiced not a { label: 'with your kids', content: 'you are raising people, not products. you let the { label: 'your home', content: 'a record of where you\'ve been. books from different c { label: 'your marriage / partner', content: 'you are not the same woman your partner  { label: 'your friendships', content: 'your friendships have seasons. the friend from  { label: 'your friday night', content: 'something that involves your inner life. a lon { label: 'your work', content: 'you have done several things. you\'ll probably do seve { label: 'how you move', content: 'investigative. you\'ve probably tried four modaliti { label: 'your shadow side', content: 'you can mistake becoming for avoiding. you have,
...
const MODIFIERS = { 
 ...
 description: 'you don\'t just live your life — you narrate it. you turn the ordinary tue shadow: 'you can live in the description more than the experience. you can write about i wink: 'you have re-read your own caption. you have written a draft text three times befo }, 
 curator: { 
 name: 'The Curator', 
 ...
 description: 'you know what\'s yours. you know what you won\'t tolerate. you will end yo shadow: 'you can be armored when you don\'t need to be. you scan for threats even in roo wink: 'you have left a doctor\'s office. you have a text thread with a friend that is ju }, 
 wit: { 
 name: 'The Wit', 
...
const QUESTIONS = [ 
 { id: 1, prompt: 'nothing is on fire. nothing is scheduled. what do you do first:', type: ' { text: 'the car gets packed. we figure out where we\'re going on the way.', scores: { w { text: 'i start a project i\'ve been thinking about all week.', scores: { feral: 2, for { text: 'slow breakfast, music, candle even though it\'s morning.', scores: { muse: 2, h { text: 'the kids do their thing. i do mine. nobody talks for an hour.', scores: { notic { text: 'house first. i can\'t enjoy a day with a sink full of dishes.', scores: { force: { text: 'figure out who\'s coming over. food once i know.', scores: { gatherer: 2, wildf { text: 'check in on the friend who\'s having a hard week.', scores: { hearth: 2, notice { text: 'clear my inbox while the coffee brews. the day is better that way.', scores: {  { text: 'open the book i\'m reading. kids know i\'m a person.', scores: { pilgrim: 2, no
 { text: 'get the workout in. it\'s already on the schedule.', scores: { force: 2 } },  { text: 'move my body first. a walk, a stretch, whatever it asks for.', scores: { notice ]}, 
 ...
 { id: 10, prompt: 'if your kids had to describe you to a stranger, they\'d say:', type: 'l { text: '"my mom takes us everywhere."', scores: { wildflower: 2 } },  { text: '"my mom can fix anything."', scores: { feral: 2 } }, 
 ...
 { id: 16, prompt: 'if someone left you a one-line note on the kitchen counter, it\'d proba { text: '"this is so well-said i\'m putting it on the fridge."', scores: { storyteller:  { text: '"how did you make this look like this."', scores: { curator: 2 } },  { text: '"thank you. nobody else would have said something."', scores: { defender: 2 } },  { text: '"i\'m crying. send help. you ruined me."', scores: { wit: 2 } }  ]}, 
...
export default function App() { 
 ...
 <div className="space-y-4 text-stone-600 text-base leading-relaxed mb-12">  <p>not a personality test. not a diagnosis.</p> 
 <p>just a vibe check that ends with someone (me) telling you what your actual su <p>twenty questions. about five minutes.</p> 
 <p>no email required, no homework after, no five-step framework. just a fun thin </div> 
 <button  
 ...
 <div className="mb-8"> 
 <div className="flex justify-between text-xs uppercase tracking-[0.2em] text-sto
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-stone-400 mb-6">your archety <h1 className="text-3xl md:text-4xl italic mb-3 leading-tight">
 {primary.name} 
 <br/> 
 <span className="text-stone-300">{modifier.name}</span> 
 </h1> 
 <p className="text-sm text-stone-400 mb-8 italic"> 
 with a {secondary.name} running underneath 
 </p> 
 ...
 <p className="text-xs uppercase tracking-[0.3em] text-stone-500 mb-4">your vibe in <p className="text-3xl italic text-stone-800">{primary.vibe}</p>  </div> 
 </div> 
 ...
 <div key={key} className={`bg-white p-4 border ${key === primaryKey ? 'borde <div className="flex items-baseline justify-between mb-2">  <p className="font-semibold italic">{core.name}</p>  {key === primaryKey && <span className="text-xs uppercase tracking-[0.15 {key === secondaryKey && <span className="text-xs uppercase tracking-[0.
 </div> 
