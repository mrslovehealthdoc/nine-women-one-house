...
const QUESTIONS = [ 
 { id: 1, prompt: 'nothing is on fire. nothing is scheduled. what do you do first:', type: ' { text: "the car gets packed. we figure out where we're going on the way.", scores: { wi { text: "i start a project i've been thinking about all week.", scores: { feral: 2, forc { text: "slow breakfast, music, candle even though it's morning.", scores: { muse: 2, he { text: 'the kids do their thing. i do mine. nobody talks for an hour.', scores: { notic { text: "house first. i can't enjoy a day with a sink full of dishes.", scores: { force: { text: "figure out who's coming over. food once i know.", scores: { gatherer: 2, wildfl
 { text: "check in on the friend who's having a hard week.", scores: { hearth: 2, noticer: { text: 'clear my inbox while the coffee brews. the day is better that way.', scores: {  { text: "open the book i'm reading. kids know i'm a person.", scores: { pilgrim: 2, noti { text: "get the workout in. it's already on the schedule.", scores: { force: 2 } },  { text: 'move my body first. a walk, a stretch, whatever it asks for.', scores: { notice ]}, 
